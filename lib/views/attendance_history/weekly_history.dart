...
class _AttendanceHistoryScreenState extends State<AttendanceHistoryScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                    child: statsBox("Total Hours", "38h 30m",
                        valueColor: Colors.black)),
                SizedBox(width: w * 0.03),
                Expanded(
                    child: statsBox("Overtime", "2h 15m",
      ...
      onTap: () {
        if (index == 1) {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => const AttendanceMonthlyHistory(),
            ),
          );
        } else {
  ...
  /// STATS BOX
  Widget statsBox(String title, String value,
