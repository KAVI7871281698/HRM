...
class _EmployeeDetailsScreenState extends State<EmployeeDetailsScreen> {
  ...
  Widget details() {
    return Column(
      children: [
        row("Employee Name", "Murali"),
        row("Department", "Flutter Dept"),
        row("Shift", "General"),
        row("Employee Type", "Permanent"),
  ...
  Widget PersonDetails() {
    return Column(
      children: [
        row("Date of Birth", "14-09-2004"),
        row("Age", "21"),
        row("Gender", "Male"),
        row("Address", "Dubai kurukusandhu"),
        row("Phone Number", "9080795171"),
      ],
    );
  }
